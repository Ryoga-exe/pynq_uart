...
proc create_root_design { parentCell } {
  ...
  set HD_GPIO_2 [ create_bd_port -dir I HD_GPIO_2 ]
...
\
  ...
  connect_bd_net -net HD_GPIO_2_0_1  [get_bd_ports HD_GPIO_2] \
  [get_bd_pins top_0/HD_GPIO_2]
  connect_bd_net -net top_0_HD_GPIO_1  [get_bd_pins top_0/HD_GPIO_1] \
  [get_bd_ports HD_GPIO_1]
  connect_bd_net -net top_0_LED  [get_bd_pins top_0/LED] \
  [get_bd_ports LED]
